...
p = plot(x_indices, elec_price, label="Daily Avg Cost", xlabel="Month", ylabel="Total Cost End User (\$/kWh)",
    title="Daily Electricity Price (2050)", xticks=(month_positions, month_labels), lw=2, legend=:topright)
...
savefig(joinpath(save_path, "daily_avg_cost_2050.png"))
println("Plot saved at $(joinpath(save_path, "daily_avg_cost_2050.png"))")
