...
# (Optional) Convert timestamp to DateTime if needed for further processing.
...
p = plot(x_indices, elec_price, label="Hourly Cost", xlabel="Hour Index", ylabel="Cost (\$/kWh)",
    title="Hourly Marginal Cost (2050)", lw=2, legend=:topright)
...
savefig(joinpath(save_path, "hourly_cost_2050.png"))
println("Plot saved at $(joinpath(save_path, "hourly_cost_2050.png"))")
